...
- Understand passenger behavior and spending.
...
- Rides above and below average fare
- Shortest ride duration by location
- Weekday fare analysis

### 👨‍✈️ Driver Analysis

- Top 5 drivers by earnings
- Bottom 5 drivers by earnings
- Driver ratings analysis
- Drivers with most and least rides
...
- Passenger ride frequency analysis
...
- Determined top-spending and most active passengers.
- Evaluated payment method usage patterns.
- Compared fare trends across rides and locations.
